...
export const Fonts: FunctionComponent<Props> = ({ url, theme }) => {
  ...
  // MobiFone corporate UI font. Medium is intentionally mapped to the regular
  // UI weight so controls do not rely on browser-synthesized glyphs.
  const mobiFoneHandelGothic: FontFace = {
    family: 'MobiFone HandelGothic',
    variants: [
      {
        weight: 400,
        style: 'normal',
        format: 'opentype',
        sources: [`${url}/fonts/handel_gothic/VIE-HandelGothic%20Medium.otf`],
      },
      {
        weight: 400,
        style: 'italic',
        format: 'opentype',
        sources: [`${url}/fonts/handel_gothic/VIE-HandelGothic-MediumItal.otf`],
      },
      {
        weight: 700,
        style: 'normal',
        format: 'opentype',
        sources: [`${url}/fonts/handel_gothic/VIE-HandelGothic-Bold.otf`],
      },
      {
        weight: 700,
        style: 'italic',
        format: 'opentype',
        sources: [`${url}/fonts/handel_gothic/VIE-HandelGothic-BoldItalic.otf`],
      },
    ],
  };
  ...
  */
  ...
  const fontText = mobiFoneHandelGothic;
  ...
  const fontsDefinitionRules = [
    interUi,
    sourceSans3,
    roboto,
    sourceCodePro,
    rubik,
    mobiFoneHandelGothic,
  ]
